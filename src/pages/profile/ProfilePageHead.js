...
export function ProfilePageHead({ profilePic, userName, profileDesc, rank, level }) {
  return (
    <div className="relative flex items-center flex-col w-10/12 h-1/2 mt-12">
      ...
      <div className="relative flex items-center flex-row gap-[2vh] w-full h-3/5">
        <div className="relative flex items-center flex-col w-5/12 h-full">
          <div className="relative w-max h-max rounded-md bg-gray-800">
            <img
        ...
        <div className="relative flex items-start flex-col gap-[2vh] w-full h-full">
